...
param clusterName string = '${envName}-aks-cluster'
...
param vnetName string = '${envName}-aks-vnet'
param aksNodeSubnetName string = '${envName}-aks-subnet'
param aksPodCidr string = '10.224.128.0/17'
param aksMiName string = '${envName}-aks-identity'
